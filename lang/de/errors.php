...
return [
    ...
    'instagram_session_expired' => 'Deine Instagram-Sitzung ist abgelaufen oder ungültig. Aktualisiere INSTAGRAM_SESSION_ID in der .env-Datei (Chrome → F12 → Application → Cookies → sessionid) und versuche es erneut.',
