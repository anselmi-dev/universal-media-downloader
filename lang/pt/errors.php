...
return [
    ...
    'instagram_session_expired' => 'A sessão do Instagram expirou ou não é mais válida. Atualize o INSTAGRAM_SESSION_ID no arquivo .env (Chrome → F12 → Application → Cookies → sessionid) e tente novamente.',
