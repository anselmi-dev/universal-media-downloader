...
return [
    ...
    'instagram_session_expired' => 'Your Instagram session has expired or is no longer valid. Update INSTAGRAM_SESSION_ID in the .env file (Chrome → F12 → Application → Cookies → sessionid) and try again.',
