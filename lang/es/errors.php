...
return [
    ...
    'instagram_session_expired' => 'La sesión de Instagram expiró o ya no es válida. Actualiza INSTAGRAM_SESSION_ID en el archivo .env (Chrome → F12 → Application → Cookies → sessionid) e inténtalo de nuevo.',
