...
return [
    ...
    'instagram_session_expired' => 'Votre session Instagram a expiré ou n\'est plus valide. Mettez à jour INSTAGRAM_SESSION_ID dans le fichier .env (Chrome → F12 → Application → Cookies → sessionid) puis réessayez.',
