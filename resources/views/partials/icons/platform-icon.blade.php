...
@switch($platform)
    @case('twitter')
        {{-- X / Twitter logo --}}
        <svg class="w-5 h-5 text-[#646464]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    @case('instagram')
        ...
        <svg class="w-5 h-5 text-[#646464]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
