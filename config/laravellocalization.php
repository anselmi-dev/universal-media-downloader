...
return [
    ...
    'supportedLocales' => [
        ...
        'de'          => ['name' => 'German',                 'script' => 'Latn', 'native' => 'Deutsch', 'regional' => 'de_DE'],
        'pt'          => ['name' => 'Portuguese',             'script' => 'Latn', 'native' => 'português', 'regional' => 'pt_BR'],
    ...
    // false = todas las URLs tienen prefijo de idioma (/en/, /es/) para hreflang SEO
    ...
    // Defaults to []
    'urlsIgnored' => ['/download', '/admin', '/admin/*', '/up', '/locale/*', '/livewire/*', '/_ignition/*', '/favicon*'],
